...
def parse_config_into_btc_config():
    ...
    config_dict["PACKAGE_STRING"] = f"\"AustraliaCash Core {version}\""
...
def main():
    parser = argparse.ArgumentParser(description='AustraliaCash-core msbuild configuration initialiser.')
