...
First, in terms of structure, there is no particular concept of "AustraliaCash Core
...
Before you start contributing, familiarize yourself with the AustraliaCash Core build
system and tests. Refer to the documentation in the repository on how to build
AustraliaCash Core and how to run the unit tests, functional tests, and fuzz tests.
...
[AustraliaCash Core PR Review Club](https://bitcoincore.reviews/) meeting.
...
fork of AustraliaCash Core copies the merge. Instead, make any username mentions in a
