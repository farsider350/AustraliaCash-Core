...
"""Verify that starting coin with -h works as expected."""
import subprocess
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start coin with -h for help text")
        ...
        self.log.info("Start coin with -version for version information")
