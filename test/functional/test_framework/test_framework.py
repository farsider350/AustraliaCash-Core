...
class BitcoinTestFramework():
    ...
    def main(self):
        ...
        parser.add_option("--srcdir", dest="srcdir", default=os.path.normpath(os.path.dirname(os.path.realpath(__file__)) + "/../../../src"),
                          help="Source directory containing australiacashd/australiacash-cli (default: %default)")
    ...
    def assert_start_raises_init_error(self, i, extra_args=None, expected_msg=None, *args, **kwargs):
        with tempfile.SpooledTemporaryFile(max_size=2**16) as log_stderr:
            try:
                ...
                assert 'australiacashd exited' in str(e)  # node must have shutdown
    ...
    def _initialize_chain(self):
        ...
        if create_cache:
            ...
            for i in range(MAX_NODES):
                ...
                args = [os.getenv("LITECOIND", "australiacashd"), "-server", "-keypool=1", "-datadir=" + datadir, "-discover=0"]
                if i > 0:
...
class ComparisonTestFramework(BitcoinTestFramework):
    ...
    Sets up some australiacashd binaries:
    ...
    def add_options(self, parser):
        parser.add_option("--testbinary", dest="testbinary",
                          default=os.getenv("LITECOIND", "australiacashd"),
