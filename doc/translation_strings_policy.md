...
This document provides guidelines for internationalization of the AusCash Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `auscash_en.ts` remains unchanged.
