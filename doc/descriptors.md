...
Since AustraliaCash Core v0.17, there is support for Output Descriptors. This is a
...
transactions related to the multisig. Lastly, it is not recommended to use anything other than a AustraliaCash Core descriptor wallet to serve as your
...
All RPCs in AustraliaCash Core will include the checksum in their output. Only
