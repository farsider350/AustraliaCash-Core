...
* coin.conf: contains configuration settings for coind or coin-qt
* coind.pid: stores the process id of coind while running
...
* debug.log: contains debug information and general logging generated by coind or coin-qt
