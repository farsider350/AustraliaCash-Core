...
Below are some notes on how to build AusCash Core for Windows.
...
way. This will install to `c:\workspace\auscash`, for example:

    make install DESTDIR=/mnt/c/workspace/auscash
