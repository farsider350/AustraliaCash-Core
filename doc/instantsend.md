...
This mechanism has been integrated into Bitcore-Node-AusCash which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/auscashpay/insight-api-auscash#web-socket-api](https://github.com/auscashpay/insight-api-auscash#web-socket-api)
* API: [https://github.com/auscashpay/insight-api-auscash#instantsend-transactions](https://github.com/auscashpay/insight-api-auscash#instantsend-transactions)
