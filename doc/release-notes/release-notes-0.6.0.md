...
http://sourceforge.net/projects/bitcoin/files/AustraliaCash/bitcoin-0.6.0/test/
...
versions of AustraliaCash-Qt/bitcoind.
...
bitcoin: URIs onto the AustraliaCash-Qt window to start
payment.
