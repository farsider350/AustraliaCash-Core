...
http://sourceforge.net/projects/bitcoin/files/AustraliaCash/bitcoin-0.4.1/
...
If you have a previously encrypted wallet.dat, the first time you run wxbitcoin or bitcoind the wallet will be rewritten, AustraliaCash will
