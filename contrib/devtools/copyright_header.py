...
# Copyright (c) 2019 The AusCash Core developers
...
Arguments:
    <base_directory> - The base directory of a AusCash Core source code repository.
...
YEAR = "20[0-9][0-9]"
YEAR_RANGE = '(%s)(-%s)?' % (YEAR, YEAR)
HOLDER = 'The AusCash Core developers'
...
Arguments:
    <base_directory> - The base directory of AusCash Core source code repository.
"""
...
CPP_HEADER = '''
// Copyright (c) %s The AusCash Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.
'''
...
def exec_insert_header(filename, style):
    ...
    if file_already_has_core_copyright(file_lines):
        sys.exit('*** %s already has a copyright by The AusCash Core developers'
                 % (filename))
...
Arguments:
    <file> - A source file in the AusCash Core repository.
"""
...
USAGE = """
copyright_header.py - utilities for managing copyright headers of 'The AusCash
