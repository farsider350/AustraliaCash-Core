...
The RPM spec file provided here is for AustraliaCash-Core 0.12.0 and builds on CentOS
...
[AustraliaCash git repository](https://github.com/bitcoin/bitcoin) but are not part of
...
in the bitcoin git repository. At present only an SVG version of the AustraliaCash
icon is used.
...
needed when 0.12.1 is released, a proper fix is already in the AustraliaCash git
master branch.
...
idea to build AustraliaCash Core against a static version of that library compiled
...
AustraliaCash-Core against OpenSSL or use a patched version of Boost in the build
system.
...
packaging AustraliaCash for Fedora at least since 2012.
