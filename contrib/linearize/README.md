# Linearize
Construct a linear, no-fork, best version of the AusCash blockchain. The scripts
run using Python 3 but are compatible with Python 2.

## Step 0: Install auscash_hash

https://github.com/auscashpay/auscash_hash
...
JSON-RPC server. Running `auscashd` or `auscash-qt -server` will be sufficient.
...
* `input`: auscashd blocks/ directory containing blkNNNNN.dat
