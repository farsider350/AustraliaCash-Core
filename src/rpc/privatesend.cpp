// Copyright (c) 2019-2020 The AusCash Core developers
...
static const CRPCCommand commands[] =
    { //  category              name                      actor (function)         okSafe argNames
        //  --------------------- ------------------------  -----------------------  ------ ----------
        { "auscash",               "getpoolinfo",            &getpoolinfo,            true,  {} },
        { "auscash",               "getprivatesendinfo",     &getprivatesendinfo,     true,  {} },
#ifdef ENABLE_WALLET
        { "auscash",               "privatesend",            &privatesend,            false, {} },
#endif // ENABLE_WALLET
};
