...
private:
    ...
    QString formatTxAmount(const TransactionRecord *wtx, bool showUnconfirmed=true, AustraliaCashUnits::SeparatorStyle separators=AustraliaCashUnits::SeparatorStyle::STANDARD) const;
