    ...
    : QWidget(parent), m_platform_style{platformStyle}
{
    ...
    typeWidget->addItem(tr("All but stake"), TransactionFilterProxy::ALL_TYPES ^
    ...
    typeWidget->addItem(tr("Mint by stake"), TransactionFilterProxy::TYPE(TransactionRecord::Staked));
