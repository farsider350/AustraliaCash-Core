...
public:
    ...
    QPushButton *openAustraliaCashConfButton;
    ...
    void setupUi(QDialog *OptionsDialog)
    {
        ...
        openAustraliaCashConfButton = new QPushButton(OptionsDialog);
        openAustraliaCashConfButton->setObjectName(QString::fromUtf8("openAustraliaCashConfButton"));
        openAustraliaCashConfButton->setAutoDefault(false);

        verticalLayout_Buttons->addWidget(openAustraliaCashConfButton);
    ...
    void retranslateUi(QDialog *OptionsDialog)
    {
...
#ifndef QT_NO_TOOLTIP
        prune->setToolTip(QApplication::translate("OptionsDialog", "Enabling pruning significantly reduces the disk space required to store transactions. All blocks are still fully validated. Reverting this setting requires re-downloading the entire blockchain.", nullptr));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        databaseCacheLabel->setToolTip(QApplication::translate("OptionsDialog", "Maximum database cache size. A larger cache can contribute to faster sync, after which the benefit is less pronounced for most use cases. Lowering the cache size will reduce memory usage. Unused mempool memory is shared for this cache.", nullptr));
#endif // QT_NO_TOOLTIP
        databaseCacheLabel->setText(QApplication::translate("OptionsDialog", "Size of &database cache", nullptr));
        databaseCacheUnitLabel->setText(QApplication::translate("OptionsDialog", "MiB", nullptr));
#ifndef QT_NO_TOOLTIP
        threadsScriptVerifLabel->setToolTip(QApplication::translate("OptionsDialog", "Set the number of script verification threads. Negative values correspond to the number of cores you want to leave free to the system.", nullptr));
#endif // QT_NO_TOOLTIP
...
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
        enableServer->setToolTip(QApplication::translate("OptionsDialog", "This allows you or a third party tool to communicate with the node through command-line and JSON-RPC commands.", nullptr));
#endif // QT_NO_TOOLTIP
        enableServer->setText(QApplication::translate("OptionsDialog", "Enable R&PC server", nullptr));
        tabWidget->setTabText(tabWidget->indexOf(tabMain), QApplication::translate("OptionsDialog", "&Main", nullptr));
#ifndef QT_NO_TOOLTIP
        subFeeFromAmount->setToolTip(QApplication::translate("OptionsDialog", "Whether to set subtract fee from amount as default or not.", nullptr));
#endif // QT_NO_TOOLTIP
        subFeeFromAmount->setText(QApplication::translate("OptionsDialog", "Subtract &fee from amount by default", nullptr));
        ...
        m_enable_psbt_controls->setText(QApplication::translate("OptionsDialog", "Enable &PSBT controls", nullptr));
#ifndef QT_NO_TOOLTIP
        m_enable_psbt_controls->setToolTip(QApplication::translate("OptionsDialog", "Whether to show PSBT controls.", nullptr));
#endif // QT_NO_TOOLTIP
        groupBoxHww->setTitle(QApplication::translate("OptionsDialog", "External Signer (e.g. hardware wallet)", nullptr));
        externalSignerPathLabel->setText(QApplication::translate("OptionsDialog", "&External signer script path", nullptr));
#ifndef QT_NO_TOOLTIP
        externalSignerPath->setToolTip(QApplication::translate("OptionsDialog", "Full path to a AustraliaCash Core compatible script (e.g. C:\\Downloads\\hwi.exe or /Users/you/Downloads/hwi.py). Beware: malware can steal your coins!", nullptr));
#endif // QT_NO_TOOLTIP
        tabWidget->setTabText(tabWidget->indexOf(tabWallet), QApplication::translate("OptionsDialog", "W&allet", nullptr));
#ifndef QT_NO_TOOLTIP
        mapPortUpnp->setToolTip(QApplication::translate("OptionsDialog", "Automatically open the AustraliaCash client port on the router. This only works when your router supports UPnP and it is enabled.", nullptr));
#endif // QT_NO_TOOLTIP
        mapPortUpnp->setText(QApplication::translate("OptionsDialog", "Map port using &UPnP", nullptr));
#ifndef QT_NO_TOOLTIP
        mapPortNatpmp->setToolTip(QApplication::translate("OptionsDialog", "Automatically open the AustraliaCash client port on the router. This only works when your router supports NAT-PMP and it is enabled. The external port could be random.", nullptr));
#endif // QT_NO_TOOLTIP
        mapPortNatpmp->setText(QApplication::translate("OptionsDialog", "Map port using NA&T-PMP", nullptr));
#ifndef QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        connectSocks->setToolTip(QApplication::translate("OptionsDialog", "Connect to the AustraliaCash network through a SOCKS5 proxy.", nullptr));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        connectSocksTor->setToolTip(QApplication::translate("OptionsDialog", "Connect to the AustraliaCash network through a separate SOCKS5 proxy for Tor onion services.", nullptr));
#endif // QT_NO_TOOLTIP
        connectSocksTor->setText(QApplication::translate("OptionsDialog", "Use separate SOCKS&5 proxy to reach peers via Tor onion services:", nullptr));
...
#ifndef QT_NO_TOOLTIP
        showTrayIcon->setToolTip(QApplication::translate("OptionsDialog", "Show the icon in the system tray.", nullptr));
#endif // QT_NO_TOOLTIP
        showTrayIcon->setText(QApplication::translate("OptionsDialog", "&Show tray icon", nullptr));
#ifndef QT_NO_TOOLTIP
...
#endif // QT_NO_TOOLTIP
        font_groupBox->setTitle(QApplication::translate("OptionsDialog", "Monospaced font in the Overview tab:", nullptr));
        embeddedFont_radioButton->setText(QApplication::translate("OptionsDialog", "embedded \"%1\"", nullptr));
        systemFont_radioButton->setText(QApplication::translate("OptionsDialog", "closest matching \"%1\"", nullptr));
        tabWidget->setTabText(tabWidget->indexOf(tabDisplay), QApplication::translate("OptionsDialog", "&Display", nullptr));
        overriddenByCommandLineInfoLabel->setText(QApplication::translate("OptionsDialog", "Options set in this dialog are overridden by the command line:", nullptr));
        overriddenByCommandLineLabel->setText(QString());
#ifndef QT_NO_TOOLTIP
        openAustraliaCashConfButton->setToolTip(QApplication::translate("OptionsDialog", "Open the %1 configuration file from the working directory.", nullptr));
#endif // QT_NO_TOOLTIP
        openAustraliaCashConfButton->setText(QApplication::translate("OptionsDialog", "Open Configuration File", nullptr));
#ifndef QT_NO_TOOLTIP
