...
public:
    ...
    void setupUi(QDialog *CreateWalletDialog)
    {
        ...
        descriptor_checkbox->setChecked(false);
    ...
    {
        CreateWalletDialog->setWindowTitle(QApplication::translate("CreateWalletDialog", "Create Wallet", nullptr));
        wallet_name_label->setText(QApplication::translate("CreateWalletDialog", "Wallet Name", nullptr));
        wallet_name_line_edit->setPlaceholderText(QApplication::translate("CreateWalletDialog", "Wallet", nullptr));
#ifndef QT_NO_TOOLTIP
        encrypt_wallet_checkbox->setToolTip(QApplication::translate("CreateWalletDialog", "Encrypt the wallet. The wallet will be encrypted with a passphrase of your choice.", nullptr));
#endif // QT_NO_TOOLTIP
        encrypt_wallet_checkbox->setText(QApplication::translate("CreateWalletDialog", "Encrypt Wallet", nullptr));
        groupBox->setTitle(QApplication::translate("CreateWalletDialog", "Advanced Options", nullptr));
#ifndef QT_NO_TOOLTIP
        disable_privkeys_checkbox->setToolTip(QApplication::translate("CreateWalletDialog", "Disable private keys for this wallet. Wallets with private keys disabled will have no private keys and cannot have an HD seed or imported private keys. This is ideal for watch-only wallets.", nullptr));
#endif // QT_NO_TOOLTIP
        disable_privkeys_checkbox->setText(QApplication::translate("CreateWalletDialog", "Disable Private Keys", nullptr));
#ifndef QT_NO_TOOLTIP
        blank_wallet_checkbox->setToolTip(QApplication::translate("CreateWalletDialog", "Make a blank wallet. Blank wallets do not initially have private keys or scripts. Private keys and addresses can be imported, or an HD seed can be set, at a later time.", nullptr));
#endif // QT_NO_TOOLTIP
        blank_wallet_checkbox->setText(QApplication::translate("CreateWalletDialog", "Make Blank Wallet", nullptr));
#ifndef QT_NO_TOOLTIP
        descriptor_checkbox->setToolTip(QApplication::translate("CreateWalletDialog", "Use descriptors for scriptPubKey management", nullptr));
#endif // QT_NO_TOOLTIP
        descriptor_checkbox->setText(QApplication::translate("CreateWalletDialog", "Descriptor Wallet", nullptr));
#ifndef QT_NO_TOOLTIP
        external_signer_checkbox->setToolTip(QApplication::translate("CreateWalletDialog", "Use an external signing device such as a hardware wallet. Configure the external signer script in wallet preferences first.", nullptr));
#endif // QT_NO_TOOLTIP
        external_signer_checkbox->setText(QApplication::translate("CreateWalletDialog", "External signer", nullptr));
    } // retranslateUi
