...
public:
    ...
    AustraliaCashAmountField *customFee;
    ...
    void setupUi(QDialog *SendCoinsDialog)
    {
        ...
        customFee = new AustraliaCashAmountField(frameFeeSelection);
    ...
    void retranslateUi(QDialog *SendCoinsDialog)
    {
        ...
        pushButtonCoinControl->setText(QApplication::translate("SendCoinsDialog", "Inputs\342\200\246", nullptr));
        ...
        buttonChooseFee->setText(QApplication::translate("SendCoinsDialog", "Choose\342\200\246", nullptr));
#ifndef QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        buttonMinimizeFee->setToolTip(QApplication::translate("SendCoinsDialog", "Hide transaction fee settings", nullptr));
#endif // QT_NO_TOOLTIP
...
"Note:  Since the fee is calculated on a per-byte basis, a fee rate of \"100 satoshis per kvB\" for a transaction size of 500 virtual bytes (half of 1 kvB) would ultimately yield a fee of only 50 satoshis.", nullptr));
...
#ifndef QT_NO_TOOLTIP
        labelCustomFeeWarning->setToolTip(QApplication::translate("SendCoinsDialog", "When there is less transaction volume than space in the blocks, miners as well as relaying nodes may enforce a minimum fee. Paying only this minimum fee is just fine, but be aware that this can result in a never confirming transaction once there is more demand for bitcoin transactions than the network can process.", nullptr));
#endif // QT_NO_TOOLTIP
        labelCustomFeeWarning->setText(QApplication::translate("SendCoinsDialog", "A too low fee might result in a never confirming transaction (read the tooltip)", nullptr));
        ...
        labelSmartFee2->setText(QApplication::translate("SendCoinsDialog", "(Smart fee not initialized yet. This usually takes a few blocks\342\200\246)", nullptr));
        labelSmartFee3->setText(QApplication::translate("SendCoinsDialog", "Confirmation time target:", nullptr));
        optInRBF->setText(QApplication::translate("SendCoinsDialog", "Enable Replace-By-Fee", nullptr));
#ifndef QT_NO_TOOLTIP
        optInRBF->setToolTip(QApplication::translate("SendCoinsDialog", "With Replace-By-Fee (BIP-125) you can increase a transaction's fee after it is sent. Without this, a higher fee may be recommended to compensate for increased transaction delay risk.", nullptr));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
        ...
        labelBalanceName->setText(QApplication::translate("SendCoinsDialog", "Balance:", nullptr));
    } // retranslateUi
