...
public:
    ...
    QLabel *lastBlockPowHashLabel;
    QLabel *lastBlockPowHash;
    QLabel *lastBlockPowAlgoLabel;
    QLabel *lastBlockPowAlgo;
    ...
    void setupUi(QWidget *RPCConsole)
    {
        ...
        gridLayout->addWidget(lastBlockHashLabel, 12, 0, 1, 1);
        ...
        gridLayout->addWidget(lastBlockHash, 12, 1, 1, 1);

        lastBlockPowHashLabel = new QLabel(tab_info);
        lastBlockPowHashLabel->setObjectName(QString::fromUtf8("lastBlockPowHashLabel"));

        gridLayout->addWidget(lastBlockPowHashLabel, 13, 0, 1, 1);

        lastBlockPowHash = new QLabel(tab_info);
        lastBlockPowHash->setObjectName(QString::fromUtf8("lastBlockPowHash"));
        lastBlockPowHash->setCursor(QCursor(Qt::IBeamCursor));
        lastBlockPowHash->setTextFormat(Qt::PlainText);
        lastBlockPowHash->setTextInteractionFlags(Qt::LinksAccessibleByMouse|Qt::TextSelectableByKeyboard|Qt::TextSelectableByMouse);

        gridLayout->addWidget(lastBlockPowHash, 13, 1, 1, 1);

        lastBlockPowAlgoLabel = new QLabel(tab_info);
        lastBlockPowAlgoLabel->setObjectName(QString::fromUtf8("lastBlockPowAlgoLabel"));

        gridLayout->addWidget(lastBlockPowAlgoLabel, 14, 0, 1, 1);

        lastBlockPowAlgo = new QLabel(tab_info);
        lastBlockPowAlgo->setObjectName(QString::fromUtf8("lastBlockPowAlgo"));
        lastBlockPowAlgo->setCursor(QCursor(Qt::IBeamCursor));
        lastBlockPowAlgo->setTextFormat(Qt::PlainText);
        lastBlockPowAlgo->setTextInteractionFlags(Qt::LinksAccessibleByMouse|Qt::TextSelectableByKeyboard|Qt::TextSelectableByMouse);

        gridLayout->addWidget(lastBlockPowAlgo, 14, 1, 1, 1);
        ...
        gridLayout->addWidget(labelMempoolTitle, 15, 0, 1, 1);
        ...
        gridLayout->addWidget(labelNumberOfTransactions, 16, 0, 1, 1);
        ...
        gridLayout->addWidget(mempoolSize, 17, 1, 1, 1);
    ...
    void retranslateUi(QWidget *RPCConsole)
    {
        ...
        lastBlockHashLabel->setText(QApplication::translate("RPCConsole", "Last block hash", nullptr));
        lastBlockHash->setText(QApplication::translate("RPCConsole", "N/A", nullptr));
        lastBlockPowHashLabel->setText(QApplication::translate("RPCConsole", "Last block pow hash", nullptr));
        lastBlockPowHash->setText(QApplication::translate("RPCConsole", "N/A", nullptr));
        lastBlockPowAlgoLabel->setText(QApplication::translate("RPCConsole", "Last block pow algorithm", nullptr));
        lastBlockPowAlgo->setText(QApplication::translate("RPCConsole", "N/A", nullptr));
        labelMempoolTitle->setText(QApplication::translate("RPCConsole", "Mempool", nullptr));
...
#ifndef QT_NO_TOOLTIP
        peerAddrProcessedLabel->setToolTip(QApplication::translate("RPCConsole", "The total number of addresses received from this peer that were processed (excludes addresses that were dropped due to rate-limiting).", nullptr));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        peerAddrRateLimitedLabel->setToolTip(QApplication::translate("RPCConsole", "The total number of addresses received from this peer that were dropped (not processed) due to rate-limiting.", nullptr));
#endif // QT_NO_TOOLTIP
