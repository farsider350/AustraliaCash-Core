...
public:
    ...
    void retranslateUi(QDialog *Intro)
    {
        ...
        lblExplanation1->setText(QApplication::translate("Intro", "When you click OK, %1 will begin to download and process the full block chain.", nullptr));
        ...
        lblExplanation3->setText(QApplication::translate("Intro", "Please understand that deleting directory will delete your private keys as well which effectively destroys your coins. Make sure to have the backup. All the keys are stored in the wallet.dat file.", nullptr));
    } // retranslateUi
