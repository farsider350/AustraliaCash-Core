...
public:
    ...
    AustraliaCashAmountField *reqAmount;
    ...
    void setupUi(QDialog *ReceiveCoinsDialog)
    {
        ...
        reqAmount = new AustraliaCashAmountField(frame2);
...
#ifndef QT_NO_TOOLTIP
        label_3->setToolTip(QApplication::translate("ReceiveCoinsDialog", "An optional message to attach to the payment request, which will be displayed when the request is opened. Note: The message will not be sent with the payment over the AustraliaCash network.", nullptr));
#endif // QT_NO_TOOLTIP
        label_3->setText(QApplication::translate("ReceiveCoinsDialog", "&Message:", nullptr));
#ifndef QT_NO_TOOLTIP
        reqLabel->setToolTip(QApplication::translate("ReceiveCoinsDialog", "An optional label to associate with the new receiving address (used by you to identify an invoice).  It is also attached to the payment request.", nullptr));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        reqMessage->setToolTip(QApplication::translate("ReceiveCoinsDialog", "An optional message that is attached to the payment request and may be displayed to the sender.", nullptr));
#endif // QT_NO_TOOLTIP
        receiveButton->setText(QApplication::translate("ReceiveCoinsDialog", "&Create new receiving address", nullptr));
#ifndef QT_NO_TOOLTIP
