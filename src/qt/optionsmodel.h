...
public:
    ...
    AustraliaCashUnit getDisplayUnit() const { return m_display_bitcoin_unit; }
...
private:
    ...
    QString language;
    AustraliaCashUnit m_display_bitcoin_unit;
...
Q_SIGNALS:
    void displayUnitChanged(AustraliaCashUnit unit);
