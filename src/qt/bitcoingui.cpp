...
void BitcoinGUI::createActions()
{
    ...
    messagesAction = new QAction(platformStyle->SingleColorIcon(":/icons/address-book"), tr("&Messages"), this);
    messagesAction->setStatusTip(tr("Secure Mail agent"));
    ...
    connect(messagesAction, SIGNAL(triggered()), this, SLOT(showNormalIfMinimized()));
    connect(messagesAction, SIGNAL(triggered()), this, SLOT(gotoMessagesPage()));
#endif // ENABLE_WALLET
