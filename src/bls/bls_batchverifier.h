// Copyright (c) 2018-2019 The AusCash Core developers
// Distributed under the MIT/X11 software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef AUSCASH_CRYPTO_BLS_BATCHVERIFIER_H
#define AUSCASH_CRYPTO_BLS_BATCHVERIFIER_H
...
#endif //AUSCASH_CRYPTO_BLS_BATCHVERIFIER_H
