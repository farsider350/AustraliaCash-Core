...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s coin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  coin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded coin transaction") + "\n" +
              "  coin-tx [options] -create [commands]   " + _("Create hex-encoded coin transaction") + "\n" +
              "\n";
