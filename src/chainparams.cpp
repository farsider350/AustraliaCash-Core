...
// Copyright (c) 2018-2020 The AusCash Core developers
...
public:
    CMainParams() {
        ...
        consensus.vDeployments[Consensus::DEPLOYMENT_BIP147].bit = 3;
        ...
        vSeeds.emplace_back("45.32.244.142", true);
        vSeeds.emplace_back("207.148.85.226", true);
        vSeeds.emplace_back("104.27.141.137", true);
        vSeeds.emplace_back("104.20.149.177", true);
        vSeeds.emplace_back("104.24.6.35", true);
        ...
        vSporkAddresses = {"AGosXHDMGhfjXS6K8qa3LiTWQEFeptYHCQ"};
        nMinSporkKeys = 1;
...
public:
    CTestNetParams() {
        ...
        consensus.fPowNoRetargeting = false;
        consensus.nPowKGWHeight = 2002; // nPowKGWHeight >= nPowDGWHeight means "no KGW"
        consensus.nPowDGWHeight = 2002;
        ...
        vSeeds.emplace_back("australiacash.org", true);
        vSeeds.emplace_back("");
        vSeeds.emplace_back("");
        ...
        // Testnet AusCash BIP44 coin type is '1' (All coin's testnet default)
        nExtCoinType = 1;
...
public:
    CDevNetParams() {
        ...
        consensus.nPowTargetTimespan = 24 * 60 * 60; // AusCash: 1 day
        consensus.nPowTargetSpacing = 2.5 * 60; // AusCash: 2.5 minutes
        consensus.fPowAllowMinDifficultyBlocks = true;
        consensus.fPowNoRetargeting = false;
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        //vSeeds.push_back(CDNSSeedData("auscashevo.org",  "devnet-seed.auscashevo.org"));

        // Testnet AusCash addresses start with 'y'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,140);
        // Testnet AusCash script addresses start with '8' or '9'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,19);
        // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,239);
        // Testnet AusCash BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = {0x04, 0x35, 0x87, 0xCF};
        // Testnet AusCash BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
...
public:
    CRegTestParams() {
        ...
        // Regtest AusCash addresses start with 'y'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,140);
        // Regtest AusCash script addresses start with '8' or '9'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,19);
        // Regtest private keys start with '9' or 'c' (Bitcoin defaults)
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,239);
        // Regtest AusCash BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = {0x04, 0x35, 0x87, 0xCF};
        // Regtest AusCash BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = {0x04, 0x35, 0x83, 0x94};

        // Regtest AusCash BIP44 coin type is '1' (All coin's testnet default)
        nExtCoinType = 1;
